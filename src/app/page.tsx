      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
            We concentrate our efforts on key pillars to maximize our impact and drive systemic change in underprivileged, remote, and ultra-remote areas across India.
          </p>
        </div>
